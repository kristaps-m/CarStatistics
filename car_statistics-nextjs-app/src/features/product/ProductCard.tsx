  ...
  return (
    ...
    >
      <img
        ...
        alt={product.carRegistrationNumber}
        className="w-full h-48 object-cover"
      />
      <div className="p-4">
        <h1 className="text-xl font-bold mb-2">{product.id}</h1>
        <h1 className="text-xl font-bold mb-2">{product.carSpeedDate}</h1>
        <h1 className="text-xl font-bold mb-2">{product.carSpeed}</h1>
        <h1 className="text-xl font-bold mb-2">
          {product.carRegistrationNumber}
        </h1>
